...
p::list mesh2list(Mesh mesh) {
    p::list l;
    l.append( vv2list( std::get<0>(mesh) ) ); //  coords, faces, textures, normals
    l.append( vv2list( std::get<1>(mesh) ) );
    l.append( vv2list( std::get<2>(mesh) ) );
    l.append( vv2list( std::get<3>(mesh) ) );
    return l;
}
